...
<span><b style="color:green">Patients Per Month</b></span>
<br><br>
...
<button class="btn btn-success" id="pdata" style="width:100%;" onclick="showresult()">Patient Data</button><br>
<div id="patientdata" style="height:100px;width:100%;display:none;color:#555;background-color:#fff;border:1px solid #ccc;border-radius:4px;overflow-y: scroll" class="form-control">
</div>
</div>
</div><!---
