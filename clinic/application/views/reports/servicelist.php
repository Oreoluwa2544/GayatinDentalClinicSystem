<?php $this->load->view('header', array('num' => 6, 'title' => "Services Rendered")); ?>
<body>
<div class="col-xs-3 columns">
	<div class="element-container">
		<legend>Services Rendered</legend>
...
<div class="col-xs-9 columns">
	<div class="element-container row">
		...
		<!-- REPORT DETAILS -->
		<div id="results" class="col-xs-12 col-lg-6 columns" style="display:none">
			<button class="btn btn-primary" id="pdata" onclick="showresult()">View Services Tally</button><br>
			<div id="showresult" style="display:none" class="scroll-select form-control form-elem"></div>
		</div>
	</div>
</div>
...
$.post("<?php echo base_url();?>reporting/services",{
	points:points
	},
	function (data){
data=data.split("<br>");
