...
<div class="col-xs-9 columns">
	<div class="element-container row">
		...
		<div id="results" class="col-xs-6 col-lg-4 columns" style="display:none">
			<button class="btn btn-primary" id="pdata" onclick="showresult()">View Report Details</button><br>
			<div id="patientdata" style="display:none" class="scroll-select form-control form-elem"></div>
		</div>
	</div>
</div>
